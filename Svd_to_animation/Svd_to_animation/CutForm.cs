...
namespace Svd_to_animation
{
    public partial class CutForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string args = $"{trackBar1.Value} {trackBar2.Value} {trackBar3.Value} {trackBar4.Value} {trackBar5.Value} {trackBar6.Value}";
            Expendator.WriteStringInFile(this.par, args);
            if (f != null)
                this.f.Close();
            this.Hide();
            ...
            Program.StartProcess(Path.Combine(this.folder, "create.py"), () =>
            {
                ...
                new ScrollForm(this.folder, false).Show();
        ...
        private void FillTracks(int xi1 = -1, int xi2 = -1, int yi1 = -1, int yi2 = -1, int ti1 = -1, int ti2 = -1)
        {
            ...
            trackBar6.Value = ti2 < 0 ? t.Length - 1 : ti2;
